...
namespace Kentor.AuthServices.Metadata
{
    ...
    public static class MetadataLoader
    {
        ...
        public static ExtendedEntityDescriptor LoadIdp(Uri metadataUrl)
        {
            ...
            var readData=Load(metadataUrl);
            var readDataEntity=new ExtendedEntityDescriptor() { SigningCredentials = readData.SigningCredentials };

             readDataEntity = (ExtendedEntityDescriptor)readData;
      
            return (ExtendedEntityDescriptor)readDataEntity;
        }
