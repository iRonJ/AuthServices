...
namespace Kentor.AuthServices.Metadata
{
    static class SPOptionsExtensions
    {
        ...
        private static ExtendedServiceProviderSingleSignOnDescriptor addSLO(ExtendedServiceProviderSingleSignOnDescriptor thisSSOD, AuthServicesUrls urls) {


            thisSSOD.SingleLogoutServices.Add(new ProtocolEndpoint()
            {
                Binding = new Uri("urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect"),
                Location = urls.SingleLogOffUrl
